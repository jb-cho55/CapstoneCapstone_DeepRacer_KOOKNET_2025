...
- Round 1에서 보상함수를 단계적으로 확장하며
  속도와 안정성 사이의 균형을 찾는 과정을 수행
- Round 2에서 LiDAR 기반 회피 전략을 통합하여
  완주율 100% 수준의 주행 달성
- Round 3에서 범용 모델과 특정 트랙 최적화 모델 모두 실험하여
  일반화 성능과 최고 성능을 함께 비교
...
> 아래 링크에는 각 라운드별 주행 영상을 연결할 예정입니다.

### Round 1
[Round 1 주행 영상](./assets/videos/round1.md)

### Round 2
[Round 2 주행 영상](./assets/videos/round2.md)

### Round 3
[Round 3 주행 영상](./assets/videos/round3.md)

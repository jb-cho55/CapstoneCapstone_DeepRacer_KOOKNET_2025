...
[▶ YouTube에서 영상 보기](https://youtu.be/LkGCegh2IXw)
...
루트 README에는 대표 영상으로 Round 1을 배치했고,
각 라운드별 영상은 아래 링크로 확인할 수 있습니다.

- [Round 1 영상](https://youtu.be/LkGCegh2IXw)
- [Round 2 영상](https://youtu.be/Y9b_qb-hFL0)
- [Round 3 영상](https://youtu.be/UMeuYGhuFPg)
